   ...
   let selectedCountryPath = localStorage.getItem('selectedCountryPath') || "norwayRadioList.json";
    ...
    const selectedCountryPathName = localStorage.getItem('selectedCountryPathName') || "Norway";
